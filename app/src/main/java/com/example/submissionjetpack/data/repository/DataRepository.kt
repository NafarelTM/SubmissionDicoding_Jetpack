package com.example.submissionjetpack.data.repository
...
class DataRepository private constructor(
    ...
    companion object{
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, executors: AppExecutors): DataRepository {
            return INSTANCE ?: synchronized(this){
                INSTANCE ?: DataRepository(remoteData, localData, executors).apply { INSTANCE = this }
            }
        }
    }
